...
def test_justiz(case_number, entscheidungstexte, rechtssaetze):
    ...
    for item in wrapper_instance:
        ...
        assert all(key in item.keys() for key in {"type", "case_number", "european_case_law_identifier", "judicial_body", "decision_date", "published", "edited", "legal_norms", "document_url", "content_urls", "rechtssatz_number"}), "checks whether an item has all desired fields"
...
@pytest.mark.parametrize("case_number,entscheidungstexte,rechtssaetze", [("Ra 2018/22/0098", True, False), ("Ra 2018/22/0098", False, True)])
...
@pytest.mark.parametrize("case_number,entscheidungstexte,rechtssaetze", [("DSB-D122.259/0008-DSB/2015", True, False), ("DSB-D122.259/0008-DSB/2015", False, True)])
...
@pytest.mark.parametrize("case_number,entscheidungstexte,rechtssaetze", [("DG/001/2018", True, False), ("DG/001/2018", False, True)])
...
@pytest.mark.parametrize("case_number,entscheidungstexte,rechtssaetze", [("B2-PVAB/21", True, False), ("B2-PVAB/21", False, True)])
