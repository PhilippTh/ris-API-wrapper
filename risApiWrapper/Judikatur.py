...
class Justiz(_BaseClass):
    ...
    published : {"Undefined", "EinerWoche", "ZweiWochen", "EinemMonat", "DreiMonaten", "SechsMonaten", "EinemJahr"}
    ...
    -------
    dict
        Object can be iterated to return dicts containing queried cases by civil or criminal courts.
...
class Vfgh(_BaseClass):
    ...
    official_reference : str
        Search by reference in a official collection.
    index : str
        Search for cases via the official classification of areas of Austrian law.
    decision_date_from : str
        Search for decisions decided after a certain date. Format YYYY-mm-dd.
    decision_date_to : str
        Search for decisions decided before a certain date. Format YYYY-mm-dd.
    ...
    ValueError
        Is raised if the provided value is not accepted by the API.
    '''
    def __init__(self, keywords=None, case_number=None, legal_norm=None, official_reference=None, index=None, decision_date_from=None, decision_date_to=None, published="Undefined", show_entscheidungstexte=True, show_rechtssaetze=True, type_of_decision="Undefined"):
        _input_validation("published", published, ["Undefined", "EinerWoche", "ZweiWochen", "EinemMonat", "DreiMonaten", "SechsMonaten", "EinemJahr"])
...
class Vwgh(_BaseClass):
    ...
    show_rechtssaetze : bool, default True
        Whether "Rechtssätze" should be included.
    type_of_decision : {"Undefined", "Beschluss", "Erkenntnis", "BeschlussVS", "ErkenntnisVS"}
        Search only for certain types of decisions.
...
class Lvwg(_BaseClass):
    ...
    type_of_decision : {"Undefined", "Beschluss", "Erkenntnis", "Bescheid"}
        Search only for certain types of decisions.
    federal_state : {"Undefined", "Burgenland", "Kaernten", "Niederoesterreich", "Oberoesterreich", "Salzburg", "Steiermark", "Tirol", "Vorarlberg", "Wien"}
    ...
    ValueError
        Is raised if the provided value is not accepted by the API.
    '''
    def __init__(self, keywords=None, case_number=None, legal_norm=None, decision_date_from=None, decision_date_to=None, published="Undefined", show_entscheidungstexte=True, show_rechtssaetze=True, type_of_decision="Undefined", federal_state="Undefined"):
        _input_validation("published", published, ["Undefined", "EinerWoche", "ZweiWochen", "EinemMonat", "DreiMonaten", "SechsMonaten", "EinemJahr"])
...
class Gbk(_BaseClass):
    ...
    published : {"Undefined", "EinerWoche", "ZweiWochen", "EinemMonat", "DreiMonaten", "SechsMonaten", "EinemJahr"}
        Search only for decisions published within a certain period of time.
    type_of_decision : {"Undefined", "Einzelfallpruefungsergebnis", "Gutachten"}
        Search only for certain types of decisions.
    commission : {"Undefined", "BundesGleichbehandlungskommission", "Gleichbehandlungskommission"}
        Search only for decisions by a specific commission.
    senat : {"Undefined", "I", "II", "III"}
        Search only for decisions by a specific senat.
    reason_for_discrimination : {"Undefined", "Geschlecht", "EthnischeZugehoerigkeit", "Religion", "Weltanschauung", "Alter", "SexuelleOrientierung", "Mehrfachdiskriminierung"}
        Search only for decisions concerning a specific reason for discrimination.
    ...
    ValueError
        Is raised if the provided value is not accepted by the API.
    '''
    def __init__(self, keywords=None, case_number=None, legal_norm=None, decision_date_from=None, decision_date_to=None, published="Undefined", type_of_decision="Undefined", commission="Undefined", senat="Undefined", reason_for_discrimination="Undefined"):
        _input_validation("published", published, ["Undefined", "EinerWoche", "ZweiWochen", "EinemMonat", "DreiMonaten", "SechsMonaten", "EinemJahr"])
        _input_validation("type_of_decision", type_of_decision, ["Undefined", "Einzelfallpruefungsergebnis", "Gutachten"])
        _input_validation("commission", commission, ["Undefined", "BundesGleichbehandlungskommission", "Gleichbehandlungskommission"])
...
class Dsk(_BaseClass):
    ...
    ValueError
        Is raised if the provided value is not accepted by the API.
    '''
    def __init__(self, keywords=None, case_number=None, legal_norm=None, decision_date_from=None, decision_date_to=None, published="Undefined", show_entscheidungstexte=True, show_rechtssaetze=True, type_of_decision="Undefined", authority="Undefined"):
        _input_validation("published", published, ["Undefined", "EinerWoche", "ZweiWochen", "EinemMonat", "DreiMonaten", "SechsMonaten", "EinemJahr"])
...
class Pvak(_BaseClass):
    ...
    show_rechtssaetze : bool, default True
        Whether "Rechtssätze" should be included.
    authority : {"Undefined", "PersonalvertretungsAufsichtskommission", "Personalvertretungsaufsichtsbehoerde"}
        Search only for decisions by a specific authority.
...
def _rechtssatz_or_enscheidungstext(arguments:dict, show_entscheidungstexte:bool, show_rechtssaetze:bool) -> dict:
    '''
    "Dokumenttyp[SucheInRechtssaetzen]" or "Dokumenttyp[SucheInEntscheidungstexten]" require "On" if the corresponding information should be shown. If the corresponding information should not be shown, no parameter should be provided.
    '''
    ...
    if not show_entscheidungstexte and show_rechtssaetze:
        ...
        return arguments
    raise ValueError('"show_entscheidungstexte" and "show_rechtssaetze" cannot both be False. Please provide at least one argument as True.')
